...
$vmSize = "Standard_A1_v2"  # Tamaño liviano
$adminUser = "azureuser"
$adminPassword = ConvertTo-SecureString "Cosas3891610" -AsPlainText -Force

# Lista de VMs
$vms = @(
    @{ Name = "SRV01"; PrivateIP = "10.10.0.4" },
    @{ Name = "SRV02"; PrivateIP = "10.10.0.5" },
    @{ Name = "SRV03"; PrivateIP = "10.10.0.6" }
)
...
foreach ($vm in $vms) {
    ...
    Write-Host "`nCreando VM: $vmName con IP: $privateIp`n"
